...
def process_episode(episode):
    ...
    # wav_filename = os.path.join('podcasts', file_prefix + '.wav')
    # if not os.path.exists(wav_filename):
    #     print(f'Converting {mp3_filename} to wav...')
    ...
    # markdown1_ouput = os.path.join('markdown', file_prefix + '.1.md')
    #
    ...
    # corrected_json['link'] = episode['url']
    # corrected_json = add_speaker_identification(corrected_json, speakers_json_filename)
    # whisper_pyannote_fusion.transcript_to_workdown(corrected_json, markdown1_ouput)
